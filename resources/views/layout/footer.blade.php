<footer id="footer">
	...
	<div id="footer-widgets">
		<div class="row">
			...
			<div id="text-2" class="widget widget_text"><h3 class="footer-widget-title">Sobre nós</h3>			<div class="textwidget">Buscamos vagas de emprego nos principais sites do ramo, para que você consiga encontrar uma vaga de maneira mais rápida.
</div>
		</div>			</div><!-- /.col-md-3 -->
...
<form role="form">
							...
							<button type="button" class="btn-newstler">Cadastre-se</button>
						</form>
			...
			<div id="footer-text" class="container">
			 2017 © <a href="">Igor Roberto</a>. Todos diretos reservados.			</div><!-- /#footer-text -->
		</footer>
